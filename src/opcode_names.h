...
class bpf_conformance_instruction_t
{
  public:
    ...
    bpf_conformance_instruction_t(bpf_conformance_test_cpu_version_t cpu_version, ebpf_inst inst)
    {
        opcode = inst.opcode;
        this->cpu_version = cpu_version;
...
static const std::set<bpf_conformance_instruction_t, InstCmp> instructions_from_spec = {
    ...
    {bpf_conformance_test_cpu_version_t::v1, 0x14},
    {bpf_conformance_test_cpu_version_t::v1, 0x15},
    {bpf_conformance_test_cpu_version_t::v3, 0x16},
    {bpf_conformance_test_cpu_version_t::v1, 0x17},
    {bpf_conformance_test_cpu_version_t::v1, 0x18, 0x00},
    {bpf_conformance_test_cpu_version_t::v1, 0x18, 0x01},
    {bpf_conformance_test_cpu_version_t::v1, 0x18, 0x02},
    {bpf_conformance_test_cpu_version_t::v1, 0x18, 0x03},
    {bpf_conformance_test_cpu_version_t::v1, 0x18, 0x04},
    {bpf_conformance_test_cpu_version_t::v1, 0x18, 0x05},
    {bpf_conformance_test_cpu_version_t::v1, 0x18, 0x06},
    {bpf_conformance_test_cpu_version_t::v1, 0x1c},
    {bpf_conformance_test_cpu_version_t::v1, 0x1d},
    {bpf_conformance_test_cpu_version_t::v3, 0x1e},
    {bpf_conformance_test_cpu_version_t::v1, 0x1f},
    {bpf_conformance_test_cpu_version_t::v1, 0x24},
    {bpf_conformance_test_cpu_version_t::v1, 0x25},
    {bpf_conformance_test_cpu_version_t::v3, 0x26},
    {bpf_conformance_test_cpu_version_t::v1, 0x27},
    {bpf_conformance_test_cpu_version_t::v1, 0x2c},
    {bpf_conformance_test_cpu_version_t::v1, 0x2d},
    {bpf_conformance_test_cpu_version_t::v3, 0x2e},
    {bpf_conformance_test_cpu_version_t::v1, 0x2f},
    {bpf_conformance_test_cpu_version_t::v1, 0x34, 0x00, 0x00, 0x00},
    {bpf_conformance_test_cpu_version_t::v4, 0x34, 0x00, 0x00, 0x01},
    {bpf_conformance_test_cpu_version_t::v1, 0x35},
    {bpf_conformance_test_cpu_version_t::v3, 0x36},
    {bpf_conformance_test_cpu_version_t::v1, 0x37, 0x00, 0x00, 0x00},
    {bpf_conformance_test_cpu_version_t::v4, 0x37, 0x00, 0x00, 0x01},
    {bpf_conformance_test_cpu_version_t::v1, 0x3c, 0x00, 0x00, 0x00},
    {bpf_conformance_test_cpu_version_t::v4, 0x3c, 0x00, 0x00, 0x01},
    {bpf_conformance_test_cpu_version_t::v1, 0x3d},
    {bpf_conformance_test_cpu_version_t::v3, 0x3e},
    {bpf_conformance_test_cpu_version_t::v1, 0x3f, 0x00, 0x00, 0x00},
    {bpf_conformance_test_cpu_version_t::v4, 0x3f, 0x00, 0x00, 0x01},
    {bpf_conformance_test_cpu_version_t::v1, 0x44},
    {bpf_conformance_test_cpu_version_t::v1, 0x45},
    {bpf_conformance_test_cpu_version_t::v3, 0x46},
    {bpf_conformance_test_cpu_version_t::v1, 0x47},
    {bpf_conformance_test_cpu_version_t::v1, 0x4c},
    {bpf_conformance_test_cpu_version_t::v1, 0x4d},
    {bpf_conformance_test_cpu_version_t::v3, 0x4e},
    {bpf_conformance_test_cpu_version_t::v1, 0x4f},
    {bpf_conformance_test_cpu_version_t::v1, 0x54},
    {bpf_conformance_test_cpu_version_t::v1, 0x55},
    {bpf_conformance_test_cpu_version_t::v3, 0x56},
    {bpf_conformance_test_cpu_version_t::v1, 0x57},
    {bpf_conformance_test_cpu_version_t::v1, 0x5c},
    {bpf_conformance_test_cpu_version_t::v1, 0x5d},
    {bpf_conformance_test_cpu_version_t::v3, 0x5e},
    {bpf_conformance_test_cpu_version_t::v1, 0x5f},
    {bpf_conformance_test_cpu_version_t::v1, 0x61},
    {bpf_conformance_test_cpu_version_t::v1, 0x62},
    {bpf_conformance_test_cpu_version_t::v1, 0x63},
    {bpf_conformance_test_cpu_version_t::v1, 0x64},
    {bpf_conformance_test_cpu_version_t::v1, 0x65},
    {bpf_conformance_test_cpu_version_t::v3, 0x66},
    {bpf_conformance_test_cpu_version_t::v1, 0x67},
    {bpf_conformance_test_cpu_version_t::v1, 0x69},
    {bpf_conformance_test_cpu_version_t::v1, 0x6a},
    {bpf_conformance_test_cpu_version_t::v1, 0x6b},
    {bpf_conformance_test_cpu_version_t::v1, 0x6c},
    {bpf_conformance_test_cpu_version_t::v1, 0x6d},
    {bpf_conformance_test_cpu_version_t::v3, 0x6e},
    {bpf_conformance_test_cpu_version_t::v1, 0x6f},
    {bpf_conformance_test_cpu_version_t::v1, 0x71},
    {bpf_conformance_test_cpu_version_t::v1, 0x72},
    {bpf_conformance_test_cpu_version_t::v1, 0x73},
    {bpf_conformance_test_cpu_version_t::v1, 0x74},
    {bpf_conformance_test_cpu_version_t::v1, 0x75},
    {bpf_conformance_test_cpu_version_t::v3, 0x76},
    {bpf_conformance_test_cpu_version_t::v1, 0x77},
    {bpf_conformance_test_cpu_version_t::v1, 0x79},
    {bpf_conformance_test_cpu_version_t::v1, 0x7a},
    {bpf_conformance_test_cpu_version_t::v1, 0x7b},
    {bpf_conformance_test_cpu_version_t::v1, 0x7c},
    {bpf_conformance_test_cpu_version_t::v1, 0x7d},
    {bpf_conformance_test_cpu_version_t::v3, 0x7e},
    {bpf_conformance_test_cpu_version_t::v1, 0x7f},
    {bpf_conformance_test_cpu_version_t::v1, 0x84},
    {bpf_conformance_test_cpu_version_t::v1, 0x85, 0x00},
    ...
    {bpf_conformance_test_cpu_version_t::v1, 0x8d, 0x00},
    ...
    {bpf_conformance_test_cpu_version_t::v1, 0xa7},
    {bpf_conformance_test_cpu_version_t::v1, 0xac},
    ...
    {bpf_conformance_test_cpu_version_t::v3, 0xc3, 0x00, 0x41},
    {bpf_conformance_test_cpu_version_t::v3, 0xc3, 0x00, 0x50},
    {bpf_conformance_test_cpu_version_t::v3, 0xc3, 0x00, 0x51},
    {bpf_conformance_test_cpu_version_t::v3, 0xc3, 0x00, 0xa0},
    {bpf_conformance_test_cpu_version_t::v3, 0xc3, 0x00, 0xa1},
    {bpf_conformance_test_cpu_version_t::v3, 0xc3, 0x00, 0xe1},
    {bpf_conformance_test_cpu_version_t::v3, 0xc3, 0x00, 0xf1},
    {bpf_conformance_test_cpu_version_t::v1, 0xc4},
    {bpf_conformance_test_cpu_version_t::v2, 0xc5},
    {bpf_conformance_test_cpu_version_t::v3, 0xc6},
    {bpf_conformance_test_cpu_version_t::v1, 0xc7},
    {bpf_conformance_test_cpu_version_t::v1, 0xcc},
    {bpf_conformance_test_cpu_version_t::v2, 0xcd},
    {bpf_conformance_test_cpu_version_t::v3, 0xce},
    {bpf_conformance_test_cpu_version_t::v1, 0xcf},
    {bpf_conformance_test_cpu_version_t::v1, 0xd4, 0x00, 0x10},
    {bpf_conformance_test_cpu_version_t::v1, 0xd4, 0x00, 0x20},
    ...
    {bpf_conformance_test_cpu_version_t::v3, 0xdb, 0x00, 0x41},
    {bpf_conformance_test_cpu_version_t::v3, 0xdb, 0x00, 0x50},
    {bpf_conformance_test_cpu_version_t::v3, 0xdb, 0x00, 0x51},
    {bpf_conformance_test_cpu_version_t::v3, 0xdb, 0x00, 0x50},
    {bpf_conformance_test_cpu_version_t::v3, 0xdb, 0x00, 0xa0},
    {bpf_conformance_test_cpu_version_t::v3, 0xdb, 0x00, 0xa1},
    {bpf_conformance_test_cpu_version_t::v3, 0xdb, 0x00, 0xe1},
    {bpf_conformance_test_cpu_version_t::v3, 0xdb, 0x00, 0xf1},
    {bpf_conformance_test_cpu_version_t::v1, 0xdc, 0x00, 0x10},
    {bpf_conformance_test_cpu_version_t::v1, 0xdc, 0x00, 0x20},
    {bpf_conformance_test_cpu_version_t::v1, 0xdc, 0x00, 0x40},
    {bpf_conformance_test_cpu_version_t::v2, 0xdd},
    {bpf_conformance_test_cpu_version_t::v3, 0xde},
};
