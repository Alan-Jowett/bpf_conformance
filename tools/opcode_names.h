...
static const std::map<uint8_t, std::string> opcode_names = {
    ...
    {(EBPF_CLS_LDX | EBPF_MODE_MEMSX | EBPF_SIZE_B), "EBPF_OP_LDXSB"},
    {(EBPF_CLS_LDX | EBPF_MODE_MEMSX | EBPF_SIZE_H), "EBPF_OP_LDXSH"},
    {(EBPF_CLS_LDX | EBPF_MODE_MEMSX | EBPF_SIZE_W), "EBPF_OP_LDXSW"},
